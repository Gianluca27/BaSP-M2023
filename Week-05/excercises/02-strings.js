...
var fullWord = 'checkpoint'
var firstLetter = fullWord.substring(0,1);
var restOfWord = fullWord.substring(1,10);
var transformedWord = firstLetter.toUpperCase() + restOfWord.toLowerCase();
